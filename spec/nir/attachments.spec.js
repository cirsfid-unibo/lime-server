...
describe('NIR -> Attachment conversion', function () {
    ...
    it('penale/allegato1.xml', done => {
        ...
        utils.convert('penale/allegato1.xml', akn => {
            ...
            expect(utils.expressionUri(akn)).toEqual('/akn/it/act/regio_decreto/stato/1930-10-19/1398/ita@1930-10-19');
            expect(utils.expressionThis(akn)).toEqual('/akn/it/act/regio_decreto/stato/1930-10-19/1398/ita@1930-10-19!codice_penale');
    ...
    it('penale/main.xml', done => {
        ...
        utils.convert('penale/main.xml', akn => {
            ...
            expect(utils.expressionUri(akn)).toEqual('/akn/it/act/regio_decreto/stato/1930-10-19/1398/ita@1930-10-19');
            expect(utils.expressionThis(akn)).toEqual('/akn/it/act/regio_decreto/stato/1930-10-19/1398/ita@1930-10-19!main');
